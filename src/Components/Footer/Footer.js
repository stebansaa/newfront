...
const Footer = () => {
  return (
    // <div
    //   className="flex justify-center bg-base-100 p-5 border-t-[1px] border-slate-500 mx-[30px]"
    ...
    //   </a>
    //   <a href="https://t.me/jointrustswap" target="_blank" rel="noreferrer" className='flex items-center ml-3'>
