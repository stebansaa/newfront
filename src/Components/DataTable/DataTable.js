...
const DataTable = ({ dark, coinData, orderBy, setOrderBy }) => {
    ...
    return (
        // px-5
        <div className='md:px-[3rem] px-[0.5rem]'  a href="https://t.me/jointrustswap">
           ...
           <div className='bg-[#FBF0DF] gap-10 flex items-center justify-center py-[8px] lg:w-max px-5 mt-[3rem] ml-auto mt-[4.25rem] rounded'>
                ...
                <span className='text-[#021a50] text-[20px]'>Support us on Pomelo season 4!</span>
           </div>
           </a>
            <h3 className='text-3xl mb-5 mt-[-7.75rem] pl-[-0.57rem] Antelope'>Antelope market capitalization</h3>
