...
const Navbar = ({ dark, setDark, orderBy, setOrderBy }) => {
  return (
    <div className="navbar">
      <div className="border-b-[1px] w-full py-4 px-4 gap-4 md:px-16 flex justify-between flex-col md:flex-row">
        <div className="flex justify-between w-full items-center">
          ...
          <div className="flex">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center ml-3 mr-[1rem]"
            >
              <svg
                className="w-[20px]"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button
              className="swap swap-rotate navbar-btn--icon md:hidden"
            ...
            >
              {dark ? (
                ...
                <svg
                  className="swap-off fill-current w-6 h-7 text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="flex sm:flex-row pb-4 md:pb-0 items-center flex-wrap md:flex-nowrap justify-center md:justify-end gap-3">
          ...
          <button
            className="swap swap-rotate navbar-btn--icon hidden md:inline-flex"
            onClick={() => setDark(!dark)}
          >
            {dark ? (
              <svg
